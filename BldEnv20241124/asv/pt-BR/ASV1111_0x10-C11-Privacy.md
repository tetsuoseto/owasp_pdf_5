...
| :----: | -------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---: | :--: |
| 11.1.1 | Verifique se os identificadores diretos e quase-identificadores foram removidos ou codificados com hash.                                                       |   1   | D/V  |
...
| 11.1.3 | Verifique se os relatórios de importância de características do modelo comprovam que não há vazamento de identificadores além de ε = 0,01 em informação mútua. |   2   |  V   |
| 11.1.4 | Verifique se provas formais ou certificação por dados sintéticos mostram risco de reidentificação ≤ 0,05, mesmo sob ataques de ligação.                        |   3   |  V   |
...
|   #    | Description                                                                                                                                                                                                               | Level | Role |
| :----: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---: | :--: |
| 11.2.1 | Verifique se as solicitações de exclusão de dados do titular são propagadas para conjuntos de dados brutos, pontos de verificação, embeddings, logs e backups dentro dos acordos de nível de serviço de menos de 30 dias. |   1   | D/V  |
...
|   #    | Description                                                                                                                               | Level | Role |
| :----: | ----------------------------------------------------------------------------------------------------------------------------------------- | :---: | :--: |
| 11.3.1 | Verifique se os painéis de controle de contabilização da perda de privacidade alertam quando o ε acumulado excede os limites da política. |   2   | D/V  |
...
| 11.4.2 | Verificar se os monitores em tempo de execução detectam consultas inconsistentes com o propósito declarado e acionam uma recusa suave.                        |   1   | D/V  |
...
| 11.4.4 | Verifique se as provas formais de rastreabilidade demonstram que todo o ciclo de vida dos dados pessoais permanece dentro do escopo consentido.               |   3   |  V   |
...
|   #    | Description                                                                                                                                                | Level | Role |
| :----: | ---------------------------------------------------------------------------------------------------------------------------------------------------------- | :---: | :--: |
| 11.5.1 | Verifique se uma Plataforma de Gerenciamento de Consentimento (CMP) registra o status de opt-in, o propósito e o período de retenção por sujeito de dados. |   1   | D/V  |
...
| 11.6.3 | Verifique se a agregação resistente a envenenamento (por exemplo, Krum/Trimmed-Mean) está habilitada.                 |   2   |  V   |
| 11.6.4 | Verifique se as provas formais demonstram um orçamento geral de ε com menos de 5 de perda de utilidade.               |   3   |  V   |
