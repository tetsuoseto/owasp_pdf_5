...
| AE.1.2 | Encriptación en tránsito Utilice TLS para aplicaciones basadas en HTTPS, con herramientas como openSSL y python's`ssl`biblioteca. |   1.2   |
...
|   #    | Description                                                                                                                     | Section |
| :----: | ------------------------------------------------------------------------------------------------------------------------------- | :-----: |
| AE.2.1 | Herramientas de defensa contra la inyección de prompts: Utilice herramientas de protección como NeMo de NVIDIA o Guardrails AI. |   2.1   |
