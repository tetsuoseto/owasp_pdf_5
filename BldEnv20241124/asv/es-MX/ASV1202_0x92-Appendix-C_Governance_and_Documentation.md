...
| AC.3.2 | Verifique que las personas responsables posean la experiencia en seguridad adecuada.                               |   2   |  D   |
| AC.3.3 | Verifique que se establezca un comité de ética de IA o una junta de gobernanza para sistemas de IA de alto riesgo. |   3   | D/V  |
...
|   #    | Description                                                                              | Level | Role |
| :----: | ---------------------------------------------------------------------------------------- | :---: | :--: |
| AC.4.1 | Verifique que existen directrices éticas para el desarrollo y despliegue de la IA.       |   1   | D/V  |
